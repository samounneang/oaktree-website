        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="mb-16">
                <div>
                    ...
                    <h3 className="text-2xl font-bold text-gray-900 mt-4">Who we are</h3>
                    <p>Our website address is: https://oaktreeventurestudio.com.</p>
                    <h1 className="text-2xl font-bold text-gray-900 mt-4">Comments</h1>
                    ...
                    <h1 className="text-2xl font-bold text-gray-900 mt-4">Media</h1>
                    <p>If you upload images to the website, you should avoid uploading images with embedded location data (EXIF GPS) included. Visitors to the website can download and extract any location data from images on the website.</p>
                    <h1 className="text-2xl font-bold text-gray-900 mt-4">Cookies</h1>
                    ...
                    <h1>Embedded content from other websites
                    ...
                    <h1 className="text-2xl font-bold text-gray-900 mt-4">Who we share your data with
                    ...
                    <h1 className="text-2xl font-bold text-gray-900 mt-4">How long we retain your data


                    </h1>
                    <p>f you leave a comment, the comment and its metadata are retained indefinitely. This is so we can recognize and approve any follow-up comments automatically instead of holding them in a moderation queue.
                    ...
                    <h1 className="text-2xl font-bold text-gray-900 mt-4">What rights you have over your data

                    </h1>
                    <p>If you have an account on this site, or have left comments, you can request to receive an exported file of the personal data we hold about you, including any data you have provided to us. You can also request that we erase any personal data we hold about you. This does not include any data we are obliged to keep for administrative, legal, or security purposes.</p>
                    <h1 className="text-2xl font-bold text-gray-900 mt-4">Where your data is sent
